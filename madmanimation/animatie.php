...
<div id="suitcase-05">
	...
	<li id="scene07">
        ...
        <h1>
            <em>Luke</em> Wroblewski
        </h1>
		<img src="07-bg.jpg" alt="onzin"/>
        <img id="bldg-07" src="07-control-full.jpg" alt=""/>
	</li>
	<li id="scene08">
        <p>
		...
		<img id="bg-08" src="08-bg.jpg" alt="onzin"/>
        <img id="man-08" src="08-man.png" alt=""/>
	</li>
    <li id="scene09">
        <p>
    ...
    <li id="scene10">
        ...
        <h1 id="title10a">
            <em>Editor</em><br/><span>Anthony</span> Calzadilla
        </h1>
        <h1 id="title10b">
            <em>Production Designer</em><br/><span>Andy</span> Clarke
        </h1>
    ...
    <li id="scene11">
        ...
        <h1>
            <em>Opening Night Party</em>
            <br/>
            <span>(mt)</span> Media Temple
        </h1>
    ...
    <li id="scene12">
        ...
        <img class="background" src="12-bg.jpg" alt=""/>
        <img src="12-man.png" alt=""/>
    </li>
    <li id="scene13">
        <p>Happy families.</p>
        <h1>
            <em>Produced by</em>
            <br/>
            <span>Anthony</span> Calzadilla
        </h1>
        <div id="bldg-blk">
            <img src="13a-bg.jpg" alt=""/>
            <img src="13b-bg.jpg" alt=""/>
        </div>
        <img src="13-man.png" alt=""/>
    </li>
    <li id="scene14">
        <p>
        ...
        <h1>
            <small>Executive Producer</small><span>Andy</span>Clarke
        </h1>
    ...
    <li id="scene15">
        ...
        <img class="background" src="15-bg.jpg" alt=""/>
        <img src="15-man.png" alt=""/>
    </li>
    <li id="scene16">
        <p>
        ...
        <h1>
            <em>Mad</em><span class="title-men">manimation</span>
        </h1>
        <img src="06-bg.jpg" alt=""/>
        <img id="man16" src="16-man.png" alt=""/>
    </li>
</ol>
</body>
</html>
